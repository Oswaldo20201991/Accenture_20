...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity").Set DataTable("Quality", dtGlobalSheet)
...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("menuCart").highlight
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("Remove Item").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement 2")_;_script infofile_;_ZIP::ssf5.xml_;_
